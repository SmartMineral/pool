...
export default class SmartMineralMiner {

    constructor(provider, miningAccount, logFun, SmartMineral_adapter) {
        var self = this;
        ...
        this.SmartMineral_adapter = contract(SmartMineral_adapter);
        this.SmartMineral_adapter.setProvider(provider);
    ...
    async bootstrap() {
        ...
        let bte = await this.SmartMineral_adapter.deployed();
    ...
    async update_balance() {
        var bte;
        try {
            bte = await this.SmartMineral_adapter.deployed();
        } catch (error) {
            throw (error);
        }
    ...
    async update_state() {
        ...
        var self = this;
        var bte = await self.SmartMineral_adapter.deployed();
    ...
    async mine() {
        var self = this;
        var bte = await this.SmartMineral_adapter.deployed()
        try {
